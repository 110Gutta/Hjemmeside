...
<html>
    ...
    <body>
        ...
        <%
            ...
            String SQL="insert into Module(moduleid, modulename, modulefilename, moduletypefile, modulefile) values (?,?,?,?,?)";
            PreparedStatement psmt = con.prepareStatement(SQL);
            String moduleid = multi.getParameter("moduleid");
            String modulename = multi.getParameter("modulename");
            ...
            while (files.hasMoreElements())
            {
                    ...
                    if((ff!=null)&&fileAllowed)
                    {
                            ...
                            try
                            {
                                    ...
                                    psmt.setString(1, moduleid);
                                    psmt.setString(2, modulename);
