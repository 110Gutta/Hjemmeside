...
public interface Constants {
    ...
    //////////////////////////////////////////////
    /////////            SQL            /////////
    public static String sqlWriteStudent = "SELECT User.userid, User.firstname, User.lastname, User.email from User INNER JOIN Permission on User.adminid = Permission.adminid where User.adminid = 2";
