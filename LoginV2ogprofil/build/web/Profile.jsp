    ...
    <div class="container py-5">
      <div class="row">
        <div class="col-md-12 text-white">
          ...
          <p class="lead mb-5">Du lærer hvordan du kan bidra til å utvikle informasjonssystemer, og hvordan digitalisering påvirker samfunnet,</p>
